...
public class DashboardController {
    ...
    @GetMapping("/master/getPercentage")
    @ResponseBody
    public float getPercentageAnnoBySprint(Model model, CodeQualification type, int sprintID)
    {
        float result = 0; 
        float range_1 = 0;
        float range_2 = 0;
        ...
        Map<Integer,Integer> anno_count = countAnnotationByFile(model,sprintID);  
